...
param functionAppName = 'fn-np-d-idbinvest-offboarding-facade'
...
param logAnalyticsName = 'law-np-d-idbinvest-offboarding'
param appInsightsName = 'ai-np-d-idbinvest-offboarding'
